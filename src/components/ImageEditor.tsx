...
const ImageEditor = ({
  ...
  return (
    <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 z-10 flex items-center justify-center">
      <div className="bg-page rounded-xl p-12 flex flex-col gap-4">
        {/* TOP */}
        <div className="flex items-center justify-between">
          ...
          <button className="py-2 px-4 rounded-full bg-black text-white dark:bg-white dark:text-black font-bold" onClick={onClose}>
            Save
          </button>
        </div>
        {/* IMAGE CONTAINER */}
